...
// in tv_series_app/test/presentation/provider/detail_series_provider_test.dart.
...
import 'package:tv_series_app/domain/entities/series.dart' as _i9;
import 'package:tv_series_app/domain/repositories/series_repository.dart'
    as _i2;
import 'package:tv_series_app/domain/usecases/get_series_detail.dart' as _i4;
...
class MockGetSeriesDetail extends _i1.Mock implements _i4.GetSeriesDetail {
  ...
  @override
  _i5.Future<_i3.Either<_i6.Failure, _i7.Detail>> execute(int? id) =>
      (super.noSuchMethod(
        Invocation.method(
          #execute,
          [id],
        ),
        returnValue: _i5.Future<_i3.Either<_i6.Failure, _i7.Detail>>.value(
            _FakeEither_1<_i6.Failure, _i7.Detail>(
          this,
          Invocation.method(
            #execute,
            [id],
      ...
      ) as _i5.Future<_i3.Either<_i6.Failure, _i7.Detail>>);
}
