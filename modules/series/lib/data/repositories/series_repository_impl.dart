...
class SeriesRepositoryImpl implements SeriesRepository {
  final SeriesAPI remoteDataSource;
  ...
  @override
  Future<Either<Failure, Detail>> getSeriesDetail(int id) async {
    try {
  ...
  @override
  Future<Either<Failure, String>> addWatchlist(Detail series) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, String>> removeWatchlist(Detail series) async {
    try {
      final result =
  ...
  @override
  Future<Either<Failure, List<Detail>>> getWatchlistSeries() async {
